...
contract ADMAMANT is Context, IERC20, Ownable {
    ...
    string private _name = "WIN";
    string private _symbol = "$TICKETS";
    ...
    address payable public charityAddress = 0xdDFA5a69196e525cb1dEC148406D41A0fA340b34; // Charity Address
    ...
    uint256 private numTokensSellToAddToLiquidity = 1000 * 10**5 * 10**9;
